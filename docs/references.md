...
- UCI Machine Learning Repository.  
  *Concrete Compressive Strength Dataset*.  
  Disponible en: https://archive.ics.uci.edu/dataset/165/concrete+compressive+strength
...
- Géron, A. (2022).  
  *Hands-On Machine Learning with Scikit-Learn, Keras & TensorFlow* (3rd ed.). O’Reilly.
